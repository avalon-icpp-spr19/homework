...
Упростите функцию, удалив избыточные условные операторы.
...
/* Задание 5
	Написать функцию, которая проверяет возможность существования даты по введенным пользователем данных.
	Пользователь вводи данные в формате день, месяц, год.
...
/* Задание 6
	...
	Даны две различные клетки шахматной доски, Написать функцию которая которая определяет
